...
/// - When making an API call you will need to follow these steps:  - 
///  1. Construct a URL Request
///  2. Make the URL Session call
///  3. Convert the JSON Data to Swift Struct ( Mapping Swift Struct to the JSON Data)
